...
class RedisAsynPool extends AsynPool
{
     ...
     * 执行Redis命令
     *
     * TODO: refactor this method, it is too complexity.
     *
    ...
    public function execute($data)
    {
        ...
        $commandName = strtolower($data['name']);
        $commandName = $data['name'] = isset($commandMaps[$commandName]) ? $commandMaps[$commandName] : $data['name'];
        ...
        $client->{$commandName}(array_values($arguments));
    }
